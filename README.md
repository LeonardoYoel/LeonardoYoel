...
Mi nombre es *Leonardo Yoel Lindo Caballero*, soy **Cubano**, **Freelancer**, **Web Developer**..., soñador y amante del emprendimiento 💪🏻, la tecnología 📱 y la gestión empresarial 📈. Con más de seis años de experiencia combinada en tecnología, administración de redes y emprendimientos, me especializo en implementar soluciones innovadoras que integran tecnología con la gestión de proyectos.

Soy licenciado en Ciencias de la Información por la Universidad Central de las Villas (#UCLV). Mi misión es impulsar la eficiencia y el crecimiento en organizaciones mediante estrategias bien definidas, siempre orientándome hacia la mejora continua y el aprendizaje constante.
